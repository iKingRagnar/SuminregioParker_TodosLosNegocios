...
(function () {
  const PAGES = [
    ...
    { href: 'hospital.html',   label: 'Hospital', icon: '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M12 8v8M8 12h8"/>' },
    { href: 'metas.html',      label: 'Metas',    icon: '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>' },
  ];
...
.logo {
  display:flex;align-items:center;gap:.55rem;text-decoration:none;flex-shrink:0;min-width:0;
}
.logo-mark {
  display:block;
  width:auto;
