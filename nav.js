...
(function () {
  ...
  function injectSharedStyles() {
    ...
    style.textContent = `
/* Evita que la página "salte" horizontalmente al aparecer/desaparecer scrollbar o al actualizar el reloj */
...
/* Reloj ancho fijo → el flex del header no se mueve cada segundo */
#reloj, header#app-header .clock {
