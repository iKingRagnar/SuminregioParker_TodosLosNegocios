...
(function () {
  ...
  const ALLOWED_DB_TERMS = ['suminregio', 'agua', 'medicos', 'madera', 'carton', 'reciclaje'];
  ...
  function filterAllowedDatabases(list) {
    ...
    return arr.filter(function (e) {
      ...
      if (pool.indexOf('empaque') >= 0) return false;
      if (pool.indexOf('especial') >= 0) return false;
      if (pool.indexOf('suminregio') >= 0 && pool.indexOf('parker') < 0 && pool.indexOf('grupo') < 0) return false;
